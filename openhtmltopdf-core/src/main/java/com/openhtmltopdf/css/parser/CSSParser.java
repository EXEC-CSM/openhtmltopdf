...
import com.openhtmltopdf.css.mediaqueries.MediaFeatureName;
import com.openhtmltopdf.css.mediaqueries.MediaQueryExpression;
import com.openhtmltopdf.css.mediaqueries.MediaQueryItem;
import com.openhtmltopdf.css.mediaqueries.MediaQueryItem.MediaQueryQualifier;
...
public class CSSParser
{
	...
	private MediaFeatureName mediaQueryFeature() throws IOException
	{
		...
		if (nm == null)
		{
			...
			throw new CSSParseException("media feature name not identified", getCurrentLine());
		}
			...
			if (first.getPseudoElement() != null)
			{
				throw new CSSParseException(
						"A simple selector with a pseudo element cannot be " +
								"combined with another simple selector",
						getCurrentLine());
			}
