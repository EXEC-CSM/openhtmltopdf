		...
		if (cssValue.getCssValueType() == CSSValue.CSS_PRIMITIVE_VALUE)
		{
			...
			switch (primitiveType)
			{
				...
				case CSSPrimitiveValue.CSS_PX:
					...
					break;
				case CSSPrimitiveValue.CSS_IN:
					absVal = (((relVal * CM__PER__IN) * MM__PER__CM) / (ctx.getMmPerDotParent() * ctx.getDotsPerPixel()));
					break;
				case CSSPrimitiveValue.CSS_CM:
					absVal = ((relVal * MM__PER__CM) / (ctx.getMmPerDotParent() * ctx.getDotsPerPixel()));
					break;
				case CSSPrimitiveValue.CSS_MM:
					absVal = relVal / (ctx.getMmPerDotParent() * ctx.getDotsPerPixel());
					break;
				case CSSPrimitiveValue.CSS_PT:
					absVal = (((relVal * PT__PER__IN) * CM__PER__IN) * MM__PER__CM) / (ctx.getMmPerDotParent() * ctx.getDotsPerPixel());
					break;
				case CSSPrimitiveValue.CSS_PC:
					absVal = ((((relVal * PC__PER__PT) * PT__PER__IN) * CM__PER__IN) * MM__PER__CM) / (ctx.getMmPerDotParent() * ctx.getDotsPerPixel());
					break;
				case CSSPrimitiveValue.CSS_NUMBER:
					absVal = relVal;
					break;
				...
				case CSSPrimitiveValue.CSS_DPCM:
					absVal = (relVal / MM__PER__CM) / ctx.getMmPerDotParent();
					break;
				default:
